 ...
 */
    ...
    .directive('typeaheadPopup', function () {
        return {
            ...
            replace:true,
            templateUrl:'templates/partials/typeahead/typeahead-popup.html',
    ...
    .directive('typeaheadMatch', ['$templateRequest', '$compile', '$parse', function ($templateRequest, $compile, $parse) {
        return {
            ...
            link:function (scope, element, attrs) {
                var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || 'templates/partials/typeahead/typeahead-match.html';
